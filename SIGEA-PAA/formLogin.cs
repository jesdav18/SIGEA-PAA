...
namespace SIGEA_PAA
{
    ...
    public partial class formLogin : MetroFramework.Forms.MetroForm
    {
        ...
        private void determinarAutenticacionUsuario()
        {
            ...
            short tieneAcceso; //ESTADO DEL ACCESO: VERDADERO O FALSO
            ...
            lectorBD.Read();
            tieneAcceso = Convert.ToInt16(lectorBD.GetValue(0)); /*SE TRAE EL VALOR DEL CAMPO TEMPORAL LLAMADO "Resultado" SI ESTE TRUE EL LOGIN ES VALIDO, 
            ...
            switch (tieneAcceso)
            {
                ...
                case 2:
                    etiqueta = mensajeUsuario.crearMensajeEnPantalla("Este usuario ha sido desactivado", 76, 260, false, 9);
                ...
                case 0:
                    ...
                    etiqueta = mensajeUsuario.crearMensajeEnPantalla("Usuario o Contraseña Incorrectos", 76, 260, false, 9);
                    Controls.Add(etiqueta);//MOSTRANDO MENSAJE EN PANTALLA.
                    break;
            }
